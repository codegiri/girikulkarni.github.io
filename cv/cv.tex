...
\href{mailto:giridhar.kulkarni@protonmail.ch}{\small \textcolor{gray}{giridhar.kulkarni@protonmail.ch}}	
\\
...
\checklang{%
\minisec{Typesetting}  \LaTeXe, Xe\TeX, pgf/tikz, Scribus / Illustrator, Word
}{%
\minisec{Composition} \LaTeXe, Xe\TeX, pgf/tikz, Scribus / Illustrator, Word
}
\checklang{%
...
\checklang{%
\minisec{OS \& Utilities} Linux: arch/debian, Bash, Git, regex
}{%
\minisec{OS \& outils} Linux: arch/debian, Bash, Git, regex
}
\checklang{%
