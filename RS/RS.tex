\documentclass[a4paper, 12pt, DIV=13]{scrarticle}
...
\renewcommand*{\maketitle}{%
  ...
  \begin{center}%
    ...
    \rule[0.6\baselineskip]{0.5\textwidth}{1.5pt}
    \\[-0.5\baselineskip]
...
\par
My recent work was focused on computation of form-factors of quantum spin chains since it they offer a powerful and effecient tool to study the two-point correlations and its long distance behviour.
Form-factors of bound states can also reveal the role played by complex roots, leading to a possibility of comparison of exact results with predictions from the BJMST formalism.
\addsec{Past work}
